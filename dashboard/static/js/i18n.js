...
window.VM_I18N = {
  en: {
    ...
    'page.txr.title': 'Twitter / X — reply candidates',
    'page.txr.intro': 'Tweets where it would feel natural to reply "I built this thing — want to take a look?". Scrape, browse the cards, jump to the original on X, or compose a reply.',
    'txr.search': 'search',
    'txr.query': 'query',
    'txr.keywords': 'keywords',
    'txr.lang': 'lang',
    'txr.max': 'max candidates',
    'txr.min_eng': 'min engagement',
    'txr.include_rt': 'include retweets',
    'txr.scrape': 'scrape',
    'txr.reload_cache': 'reload from cache',
    'txr.candidates': 'candidates',
    'txr.empty': 'No candidates yet. Run a scrape, or load a cached result.',
    'txr.need_query': 'enter a query or keywords',
    'txr.scraping': 'scraping',
    'txr.scraped': 'scraped',
    'txr.from_cache': 'from cache',
    'txr.reply_prompt': 'reply text (≤280 chars):',
    'txr.reply_confirm': 'Send this reply?',
    'txr.reply_done': 'reply posted',
  },
  ...
  ko: {
    ...
    'page.txr.title': 'Twitter / X — 답글 후보',
    'page.txr.intro': '"이거 만들었는데 한번 보실래요?"라고 답글을 달아도 자연스러울 만한 트윗을 모아 보여줍니다. 스크랩 후 카드로 살펴보고, 원본 트윗으로 이동하거나 답글을 작성하세요.',
    'txr.search': '검색',
    'txr.query': '쿼리',
    'txr.keywords': '키워드',
    'txr.lang': '언어',
    'txr.max': '최대 후보 수',
    'txr.min_eng': '최소 인게이지먼트',
    'txr.include_rt': '리트윗 포함',
    'txr.scrape': '스크랩',
    'txr.reload_cache': '캐시 다시 불러오기',
    'txr.candidates': '후보',
    'txr.empty': '아직 후보가 없습니다. 스크랩을 실행하거나 캐시를 불러오세요.',
    'txr.need_query': '쿼리 또는 키워드를 입력하세요',
    'txr.scraping': '스크랩 중',
    'txr.scraped': '스크랩 완료',
    'txr.from_cache': '캐시 로드',
    'txr.reply_prompt': '답글 본문 (≤280자):',
    'txr.reply_confirm': '이 답글을 보내시겠어요?',
    'txr.reply_done': '답글 게시됨',
  },
  ...
  zh: {
    ...
    'page.txr.title': 'Twitter / X — 回复候选',
    'page.txr.intro': '收集那些用 "我做了这个，要不要看一下？" 来回复会显得自然的推文。抓取后浏览卡片，跳转到 X 原文或撰写回复。',
    'txr.search': '搜索',
    'txr.query': '查询',
    'txr.keywords': '关键词',
    'txr.lang': '语言',
    ...
    'txr.include_rt': '包含转推',
    'txr.scrape': '抓取',
    'txr.reload_cache': '重新载入缓存',
    'txr.candidates': '候选',
    'txr.empty': '还没有候选。运行一次抓取，或加载缓存。',
    'txr.need_query': '请输入查询或关键词',
    'txr.scraping': '抓取中',
    'txr.scraped': '已抓取',
    'txr.from_cache': '来自缓存',
    'txr.reply_prompt': '回复内容（≤280 字符）：',
    'txr.reply_confirm': '确认发送这条回复？',
    'txr.reply_done': '回复已发布',
  },
  ...
  ja: {
    ...
    'page.txr.title': 'Twitter / X — リプライ候補',
    'page.txr.intro': '「これ作ったんで、ちょっと見てもらえます？」とリプライを送るのが自然なツイートを集めます。スクレイプ後にカードで一覧、X の原文を開く、もしくはリプライを作成。',
    'txr.search': '検索',
    'txr.query': 'クエリ',
    'txr.keywords': 'キーワード',
    'txr.lang': '言語',
    'txr.max': '最大候補数',
    'txr.min_eng': '最低エンゲージ',
    'txr.include_rt': 'リツイートも含める',
    'txr.scrape': 'スクレイプ',
    'txr.reload_cache': 'キャッシュを再読込',
    'txr.candidates': '候補',
    'txr.empty': 'まだ候補がありません。スクレイプを実行するか、キャッシュを読み込んでください。',
    'txr.need_query': 'クエリまたはキーワードを入力',
    'txr.scraping': 'スクレイプ中',
    'txr.scraped': 'スクレイプ完了',
    'txr.from_cache': 'キャッシュから',
    'txr.reply_prompt': 'リプライ本文（≤280 文字）:',
    'txr.reply_confirm': 'このリプライを送信しますか？',
    'txr.reply_done': 'リプライを送信しました',
  },
};
